...
from Funny import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
                           PORT, SUPPORT_CHAT, TOKEN, URL, WEBHOOK,
                          dispatcher, StartTime, telethn, updater, pbot)
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from Funny.modules import ALL_MODULES
from Funny.modules.helper_funcs.chat_status import is_user_admin
from Funny.modules.helper_funcs.misc import paginate_modules
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text(
            '<a href="https://telegra.ph/file/4e4a61976a24845f20aa1.jpg">I was always online!</a> <b> \n Up since:</b> <code>{}</code> **'.format(uptime),
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@RedHairedPirates", "[I was never Down \n fuck off!", parse_mode=ParseMode.MARKDOWN)
        except Unauthorized:
            LOGGER.warning(
