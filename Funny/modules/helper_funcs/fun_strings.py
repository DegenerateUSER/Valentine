...
GBAM_REASON = (
    ...
    "Za Warudo!!!!!",
    "Chup Bangali",
    "Nepali Cartoon dekhna band Karo",
    "Another One Bites Da Dusto",
    "Part Skipper",
    "isne One Piece wikipedia se padh kar catch up kiya 2 hrs mai",
