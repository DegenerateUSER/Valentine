...
import Funny.modules.sql.welcome_sql as sql
import Funny
from Funny import (
    DEV_USERS,
    LOGGER,
...
from Funny.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Funny.modules.helper_funcs.msg_types import get_welcome_type
from Funny.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from Funny.modules.log_channel import loggable
from Funny.modules.sql.global_bans_sql import is_user_gbanned
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Be cool! My bot developer just joined.",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_text(
                    "Whoa! A sudo user just joined! Stay Alert!",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Support
                ...
                update.effective_message.reply_text(
                    "Huh! Someone with high powers just joined!",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_text(
                    "Hey! An immune user just joined!", reply_to_message_id=reply
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
                    f"#USER_JOINED\n"
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_text(
                    "A user with some special powers just joined!", reply_to_message_id=reply
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
                    f"#USER_JOINED\n"
