...
import Funny.modules.sql.global_bans_sql as sql
from Funny.modules.sql.users_sql import get_user_com_chats
from Funny import (
    DEV_USERS,
    EVENT_LOGS,
    STRICT_GBAN,
...
from Funny.modules.helper_funcs.misc import send_to_list
