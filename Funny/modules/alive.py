...
PHOTO = "https://telegra.ph/file/90b4bdd8e5e5bcd0cee14.jpg"

@MEMEK(pattern=("/alive"))
async def awake(event):
  tai = event.sender.first_name
  YUMEKO = "**Hello I'm Phosphophyllite!** \n\n"
  YUMEKO += "×**I'm Working Properly** \n\n"
  YUMEKO += "×**I Have No Owner Just Few Gay Devs Find Them At [GodsValley](https://t.me/GodsValley)**× \n\n"
  YUMEKO += f"×**Telethon Version : {tlhver}** \n\n"
  YUMEKO += f"×**Pyrogram Version : {pyrover}** \n\n"
  YUMEKO += "**Thanks For Adding Me Here ❤️**"
  BUTTON = [[Button.url("ʜᴇʟᴘ", "https://t.me/PhosphophylliteRobot?start=help"), Button.url("sᴜᴘᴘᴏʀᴛ", "https://t.me/KlRAYoshikage")]]
