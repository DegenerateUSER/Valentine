...
from Funny import dispatcher, updater
import Funny.modules.sql.nsfw_sql as sql
from Funny.modules.log_channel import gloggable
...
__mod_name__ = "ɴsғᴡ"
__help__ = """
*For Horny peeps only*
 ❍ /addnsfw :* enables NSFW comands.
 ❍ /rmnsfw :* Disables NSFW comands.
 Commands :   
