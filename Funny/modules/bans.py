...
from Funny.modules.helper_funcs.extraction import extract_user_and_text
from Funny.modules.helper_funcs.string_handling import extract_time
from Funny.modules.log_channel import gloggable, loggable
...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    if is_user_ban_protected(chat, user_id, member) and user not in DEV_USERS:
        if user_id == OWNER_ID:
            ...
            message.reply_text(
                "Even Banhammer can't ban this support user of mine!! ."
            )
            return log_message
        elif user_id in TIGERS:
            message.reply_text(
                "This user has immunity, can't be banned!! ."
            )
            return log_message
        elif user_id in WOLVES:
            message.reply_text("Ban immune!")
            return log_message
        else:
